    ...
    )
    {
            ...
            long? relatedOrderId = null)
        {
            ...
            logger.LogInformation(
                "Mapped bundle banner media for bundle {BundleId}: includeMedia {IncludeMedia}, eligible media rows {MediaCount}, selected banner media {BannerMediaId}, selected banner has url {BannerHasUrl}, legacy banner has url {LegacyBannerHasUrl}",
                bundle.Id,
                includeMedia,
                media.Count,
                banner?.Id,
